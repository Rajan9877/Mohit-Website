...
<head>
    <meta charset="utf-8">
    <title>Sri Anjaneyam Machines - Welcome</title>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-10 text-start">
                                    <p class="fs-5 fw-medium text-primary text-uppercase animated slideInRight">Welcome To</p>
                                    <h1 class="display-1 text-white mb-5 animated slideInRight">Sri Anjaneyam Machines</h1>
                                    <p>
At Anjaneyam, we are pioneers in the design, engineering, and construction of cutting-edge packaging machines. We are driven by a relentless pursuit of innovation, constantly pushing the boundaries of technology to achieve the extraordinary.</p>
                                    <a href="" class="btn btn-primary py-3 px-5 animated slideInRight">Our Products</a>
                                </div>
                            </div>
                        </div>
                    </div>
